  ...
  return (
    <main className="flex justify-center items-center py-10 px-4">
      <div className="flex flex-col items-center gap-4 w-full md:w-[80%] lg:w-[60%]">
        <h1 className="text-lg md:text-xl lg:text-[2.25rem] font-bold text-center">NBA PLAYER SEASON STATUS</h1>
        ...
        <input 
          ...
          className="bg-gray-200 px-4 py-3 rounded-[4px] w-full mb-6"
